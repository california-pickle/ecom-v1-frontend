    ...
    <footer className="bg-[#0a0a0a] text-white border-t-8 border-[#a3e635]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex flex-col items-center text-center">
          {/* Brand */}
          <div className=" mb-3 sm:mb-10  mtext-center">
            <Image
              src={logo}
          ...
          <p className="text-white/40 text-xs font-black uppercase tracking-widest mb-8">
            The California Pickle LLC &nbsp;·&nbsp; 1999 Harrison Street Suite
            1800 &nbsp;·&nbsp; Oakland CA 94612
          </p>

          {/* Social Icons */}
          <div className="flex items-center gap-6 sm:mb-12">
            <Link
              href="https://www.facebook.com/people/The-California-Pickle/61575237201878/"
              target="_blank"
              aria-label="Facebook"
            ...
            <Link
              href="https://www.instagram.com/thecaliforniapickle"
              target="_blank"
              className="text-white/30 hover:text-[#a3e635] transition-colors"
            >
              <InstagramIcon />
