      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div className="relative flex justify-center">
            ...
            {/* Card container */}
            <div className="relative rounded-3xl border border-[#a3e635]/10 bg-white/5 backdrop-blur-sm overflow-hidden p-2 shadow-[0_0_60px_rgba(163,230,53,0.08)]">
              <Image
                src="/bottleIng.png"
                alt="California Pickle bottle ingredients"
                width={560}
                height={660}
                className="relative z-10 w-[290px] sm:w-[380px] lg:w-[540px] h-auto object-contain rounded-2xl drop-shadow-[0_0_50px_rgba(163,230,53,0.35)]"
              />
