...
export default function WhyItWorksSection() {
  return (
    <section id="why-it-works" className="bg-[#0a0a0a] text-white py-16 sm:py-20 lg:py-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div className="relative flex justify-center">
            <div className="absolute inset-0 bg-[#a3e635]/10 rounded-3xl blur-2xl" />
              ...
              width={380}
              height={460}
              className="relative z-10 w-[200px] sm:w-[280px] lg:w-[360px] h-auto object-contain drop-shadow-[0_0_40px_rgba(163,230,53,0.3)]" />
          ...
          <div>
            ...
            <div className="space-y-6 sm:space-y-7">
              ...
              <div key={title} className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-white mb-1 text-sm sm:text-base">{title}</h3>
