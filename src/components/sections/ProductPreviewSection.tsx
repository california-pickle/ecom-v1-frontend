...
export default function ProductPreviewSection({ product }: Props) {
  ...
  return (
    <section
      id="product-preview"
      className="bg-[#0a0a0a] py-16 sm:py-24 lg:py-32"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, #a3e635 20%, #A2B971 50%, #A2B971 100%)",
          }}
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
            ...
            <div className="p-8 sm:p-12 lg:p-20 order-2 lg:order-1">
              ...
              <p className="text-black font-bold text-[15px] sm:text-lg leading-tight mb-3 sm:mb-8 uppercase tracking-tight">
                {productDescription}
              </p>
              <div className="flex items-baseline gap-3 mb-8 sm:mb-10">
                <span className="text-3xl sm:text-7xl font-black text-black tracking-tighter">
                  ${startingPrice}
                </span>
            ...
            <div className="order-1 lg:order-2 flex items-center justify-center p-6 lg:p-10">
              <div
                style={{
                  maskImage:
                    "linear-gradient(to top, transparent 0%, black 1%, black 100%)",
                  WebkitMaskImage:
                    "linear-gradient(to top, transparent 0%, black 1%, black 100%)",
                }}
              >
